...
class SpaceCarvingMapper:
    ...
    def update(self, pose, readings, sensor_params):
        ...
        for i in range(num_rays):
            ...
            angle_mask = (rel_angle >= i * d_theta - d_theta/2) & (rel_angle <= (i+1) * d_theta + d_theta/2)
        ...
        self.grid[update_mask] = (1 - self.alpha) * self.grid[update_mask] + self.alpha * current_map[update_mask]

...
#SBATCH --job-name=train_conv_lstm_nll         
#SBATCH --time=12:00:00                     
#SBATCH --cpus-per-task=8                   
#SBATCH --gpus=1                            
#SBATCH --mem=32G                           

#SBATCH --output=/home/emunoz/slurm_logs/train_conv_lstm_nll_%j.log
#SBATCH --error=/home/emunoz/slurm_logs/train_conv_lstm_nll_%j.log

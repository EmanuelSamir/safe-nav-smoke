...
apptainer exec --nv --bind /data/emunoz:/data /data/emunoz/imgs/python_full.sif /data/emunoz/envs/dev_env/bin/python projects/single_agent/step_06_full_integration/run_integration.py --config projects/single_agent/step_06_full_integration/config_cbf.yaml

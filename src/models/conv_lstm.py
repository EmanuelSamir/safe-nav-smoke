...
class ConvLSTMConfig(BaseModel):
    ...
    def validate_kernel_size(self) -> "ConvLSTMConfig":
...
def main(cfg: DictConfig):
    ...
    # 1. Validate Hydra Config using Pydantic ConvLSTMConfig
    ...
    print("Testing ConvLSTMConfig Pydantic validation constraints...")
    try:
        ConvLSTMConfig(kernel_size=4)

...
import torch
from models.model_free_utils import ObsSNP
from models.pinn_utils import ObsPINN
from models.snp_v2 import SnpV2
...
class SNPWrapper(SmokeModelWrapper):
    ...
    def predict_future(
        ...
        state = (
            self.model.init_state(batch_size, self.device)
...
class PINNWrapper(SmokeModelWrapper):
    ...
    def load_checkpoint(self, path: str, device: str):
        ...
        )  # Check naming 'model_state_dict' or 'state_dict'

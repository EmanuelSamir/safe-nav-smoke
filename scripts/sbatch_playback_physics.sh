...
#SBATCH --job-name=playback_physics          # Nombre del trabajo
...
# Redirección de logs
#SBATCH --output=/home/emunoz/slurm_logs/playback_physics_%j.log
#SBATCH --error=/home/emunoz/slurm_logs/playback_physics_%j.log
...
apptainer exec --nv --bind /data/emunoz:/data /data/emunoz/imgs/python_full.sif /data/emunoz/envs/dev_env/bin/python src/0_data_playback_physics_collection.py test=false

...
#SBATCH --job-name=training_energy_score         # Nombre del trabajo
...
apptainer exec --nv --bind /data/emunoz:/data /data/emunoz/imgs/python_full.sif /data/emunoz/envs/dev_env/bin/python src/training/train_fno.py training.loss.name=energy_score